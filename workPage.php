...
<div class="main-content container">
    ...
    <div class="row">
        ...
        <div class="btn-group">
            <button type="button" class="btn btn-default active">Print</button>
            <button type="button" class="btn btn-default">Interactive</button>
            <button type="button" class="btn btn-default active">Video</button>
        </div>
        ...
        <section class="work container-fluid">
            ...
            <article class="col-md-8">
                <div class="post-img img-responsive">
                    <img src="img/post-img.png" alt="..."  class="img-responsive">
                </div>
                <header>
                    <div class="media">
                        <div class="pull-left">
                        ...
                        <div class="media-body">
                            <h2 class="media-heading">Krili havtret hyo gustripast 1</h2>
